...
const Home = () => {
  return (
    <HelmetProvider>
      ...
      <Slider></Slider>
      <div className="flex justify-center items-center uppercase absolute top-30 px-15 lg:px-0 lg:top-44 lg:left-[400px] ">
        ...
        <h1 className="text-2xl md:text-4xl font-bold animate__animated animate__backInLeft duration-500">Best apartments to sale and rent</h1>
