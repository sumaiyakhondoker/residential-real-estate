  ...
  return (
    <HelmetProvider>
      ...
      <div className="flex justify-center items-center uppercase absolute lg:top-44 lg:left-[400px] ">
        ...
        <h3 className="text-2xl font-semibold animate__animated animate__backInLeft duration-500">Find your dream home!</h3>
        <h1 className="text-4xl font-bold animate__animated animate__backInLeft duration-500">Best apartments to sale and rent</h1>
